...
//   const appId = "3b9851a557914843b0a368d51809d6fa";
//   const appSecret = "b4388d05b03d4516bc3222c34c308d52";
//   const appSalt = "aklCMa/IqOJ0LbVW9JRF+04uph6B3KELKOG1+WQDq10=";
//   const localStorageMode = BayunCore.LocalDataStorageMode.EXPLICIT_LOGOUT_MODE;
//   const enableFaceRecognition = true;
//   const baseURL = "https://www.digilockbox.com/";

//   const bayunCore = BayunCore.init(appId, appSecret, appSalt,
//                                   localStorageMode, enableFaceRecognition, baseURL);

const Constants = {
  BAYUN_APP_ID: "f15af5c4ad334cd696d730c129ba9b99",
  BAYUN_APP_SALT: "7ogGFgF3oxZs+0geSn4set6ZxgkQdPyj7UQhUTHwVOc=",
  BAYUN_APP_SECRET: "81d5a763114c42468f7cc16a11857329",
...
function initBayunCore() {
  bayunCore = window.BayunCore.init(
...
function clearSessionData() {
  setCookie("window.sessionId", "", 30); // window.sessionId = "";
